...
for (const id of ["builtin-prism-clean", "builtin-prism-rgb-edge", "builtin-prism-immersive", "builtin-spectral-dark", "builtin-spectral-balanced", "builtin-spectral-active"]) assert.ok(variations.includes(id), `missing variation ${id}`);
...
console.log(JSON.stringify({ status: "pass", prismStyles: 3, spectralStyles: 3, builtinVariations: 6, rendererRecreatedOnVariation: false }, null, 2));
