export function transportTemplate(): string {
  return `<footer class="motion-transport" data-transport>
    ...
    <input data-motion="timeline" type="range" min="0" max="6" step="0.001" value="0" aria-label="Motion timeline">
    <label><input data-motion="transport-loop" type="checkbox" checked> Loop</label><span data-output="motion-fps">30 fps</span>
  </footer>`;
}
